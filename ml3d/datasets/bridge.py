...
class Bridge(BaseDataset):
    ...
    def __init__(self,
                 ...
                 ignored_label_inds=[],
                 ignored_objects=[],
                 test_result_folder='content/test',
                 **kwargs):
    ...
    def get_split(self, split):
        ...
        """
        return BridgeSplit(self, split=split)
...
class BridgeSplit(BaseDatasetSplit):
    ...
    def get_data(self, idx):
        ...
        labels = np.array(pc[:, 4], dtype=np.int32).reshape((-1,))
...
DATASET._register_module(Bridge)